...
namespace MusicPlaylistAnalyzer
{
    class Song
    {
        ...
        public Song(string Name, string Artists, string Album, string Genre, int Size, int Time, int Year, int Plays)
        {
            this.Name = Name;
            this.Plays = Plays;
            this.Size = Size;
        ...
        {
            return String.Format("Name: {0}, Artists: {1}, Album: {2}, Genre: {3}, Size: {4}, Time: {5}, Year: {6}, Plays: {7}", Name, Artists, Album, Genre, Size, Time, Year, Plays);
        }
    }
            ...
            try
            {
                if (File.Exists("Playlist.txt"))
                {
                    ...
                    while ((line = sr.ReadLine()) != null)
                    {
                        ...
                        {
                            Console.Write("Error has been made.");
                            break;
                        }
                    }
                    sr.Close();
                ...
                {
                    Console.WriteLine("Sorry your file was not found.");
                }

            }
            catch (Exception)
            {
                Console.WriteLine("Sorry this file can't be opened.");
            }
